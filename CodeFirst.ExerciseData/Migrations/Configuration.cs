namespace CodeFirst.ExerciseData.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CodeFirst.ExerciseData.VidzyContext>
    {
        ...
        protected override void Seed(CodeFirst.ExerciseData.VidzyContext context)
        {
            context.Videos.AddOrUpdate(v => v.Id, new Video
            {
                ...
                Classification = Models.Classification.Platinum,
                GenreId = 7
            });
            ...
            context.Videos.AddOrUpdate(v => v.Id, new Video
            {
                ...
                Classification = Models.Classification.Gold,
                GenreId = 7
            });
            ...
            context.Videos.AddOrUpdate(v => v.Id, new Video
            {
                ...
                Classification = Models.Classification.Silver,
                GenreId = 1
            });
